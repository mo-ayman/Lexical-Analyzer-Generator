...
class PPT {
private:
	map<Definition*,map<Definition*,vector<Definition*>>>* PPTable =new map<Definition*,map<Definition*,vector<Definition*>>>();
...
public:
    ...
    map<Definition*, map<Definition*, vector<Definition*>>>* get_PPT();
    void fillFirstChunck();
    void fillFollowChunck();
    int checkEpslon(vector<pair<int, Definition*>> mappingFirst);
    void print(map<Definition*, map<Definition*, vector<Definition*>>>* table);
};
