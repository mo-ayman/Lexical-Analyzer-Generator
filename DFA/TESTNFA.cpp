...
int main() {
    ...
    int initialState = 0;
    Epslon_NFA_NFA obj(transitionTable, finalStates, initialState);
    ...
    unordered_map<int, tuple<string, Priority, int>>  mapFinal = obj.get_Final_States();
